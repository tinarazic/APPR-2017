...
GRUPIRANJE:
```{r zemlJ_skupine, echo=FALSE, warning = FALSE, fig.align='center', fig.cap='Grupiranje držav glede na število ločitve in število porok',message = FALSE}
source("analiza/grupiranje.r", encoding = "UTF-8")
print(zemlj_skupine)
```


POVEZAVA: POVPREČNA STAROST IN ŠTEVILO LOČITEV
